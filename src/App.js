...
function App() {
  return (
    <Container maxW='100%'  bgColor='gray.800'>
        ...
        <Box px='10' pt='8'>
          <iframe style={{borderRadius:'12px'}} src="https://open.spotify.com/embed/playlist/2nNfnGIn1pyU1FG38obxEQ?utm_source=generator" width="100%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
        </Box>
        <Box px='10' pt='8'>
